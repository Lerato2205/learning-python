...
turtle.circle(40, steps = 3) # Draw a triangle	draw a triangle
...
turtle.end_fill() # Fill the shape 19
turtle.penup()
turtle.goto(0, -50)
turtle.pendown()
turtle.begin_fill() # Begin to fill color in a shape
...
turtle.end_fill() # Fill the shape 27
turtle.penup()
turtle.goto(100, -50)
turtle.pendown()
turtle.begin_fill() # Begin to fill color in a shape
...
turtle.end_fill() # Fill the shape 35
turtle.penup()
turtle.goto(200, -50)
turtle.pendown()
turtle.begin_fill() # Begin to fill color in a shape
